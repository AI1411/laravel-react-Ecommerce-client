...
const ShoppingCart = (props: any) => {
    ...
    const getPrice = () => {
        ...
        cartItems.map((item: any) => {
            sum.price += item.product.price;
            sum.tax += item.product.tax;
            sum.total += item.product.price_include_tax;
        })
        return sum;
    }
                ...
                <div className="flex-1">
                    ...
                    <div className="my-4 mt-6 -mx-2 lg:flex">
                        <div className="lg:px-2 lg:w-1/2">
                            ...
                            <div className="p-4">
                                <p className="mb-4 italic">If you have a coupon code, please enter it in the box
                                    below</p>
                            ...
                            <div className="p-4">
                                <p className="mb-4 italic">If you have some information for the seller you can leave
                        ...
                        <div className="lg:px-2 lg:w-1/2">
                            ...
                            <div className="p-4">
                                <p className="mb-6 italic">Shipping and additionnal costs are calculated based on
