            ...
            <div className="flex flex-col sm:flex-row sm:justify-around">
                <div className="w-64 h-screen bg-white">
                    ...
                    <nav className="mt-10">
                        ...
                        <Link className={`flex items-center mt-5 py-2 px-8 text-gray-600 ${props.active === "rankings" && 'bg-gray-200'} border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700`}
                              to={'/admin/ranking'}>
                            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M15 5V7M15 11V13M15 17V19M5 5C3.89543 5 3 5.89543 3 7V10C4.10457 10 5 10.8954 5 12C5 13.1046 4.10457 14 3 14V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V14C19.8954 14 19 13.1046 19 12C19 10.8954 19.8954 10 21 10V7C21 5.89543 20.1046 5 19 5H5Z"
                            ...
                            <span className="mx-4 font-medium">Ranking</span>
                        </Link>

                        <a className="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700"
                           href="#">
                            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
