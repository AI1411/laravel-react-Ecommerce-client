...
const CategoryRankings = (props: any) => {
    ...
    const getRankings = async () => {
        const response = await axios.get(`http://stars.test/api/rankings/${targetSlug}`);
    ...
    return (
        <Wrapper>
            <section className="bg-white py-8 flex">
                ...
                <div className="flex-auto">
                    <div className="container mx-auto flex items-center flex-wrap">{targetSlug}ランキング</div>
